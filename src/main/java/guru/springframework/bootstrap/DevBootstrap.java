...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.debug("Bootstrap -Loading Bootstrap data");
    ...
    private List<Recipe> getRecipes() {
        ...
        Set<Optional<UnitOfMeasure>> uoms = new HashSet<>(Arrays.asList(eachUomOptional,tableSpoonUomOptional,teaSpoonUomOptional,
                dashUomOptional,pintUomOptional,cupsUomOptional));
        ...
        Set<Optional<Category>> categories = new HashSet<>(Arrays.asList(americanCategoryOptional,mexicanCategoryOptional));
